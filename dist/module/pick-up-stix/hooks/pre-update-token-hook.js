...
import { collidedTokens } from "../../../utils.js";
import { deleteToken, handleItemDropped, normalizeDropData } from "../main.js";
/**
 ...
 */
export const preUpdateTokenHook = async (scene, tokenData, updates, options, userId) => {
    log(`pick-up-stix | preUpdateTokenHook:`);
    log([scene, tokenData, updates, options, userId]);
    const tokenFlags = getProperty(tokenData, 'flags.pick-up-stix.pick-up-stix');
...
//# sourceMappingURL=../../../maps/module/pick-up-stix/hooks/pre-update-token-hook.js.map
