...
import { getCanvas, SettingKeys } from "./module/pick-up-stix/settings.js";
...
export function getQuantityDataPath() {
    let path;
...
export function getPriceDataPath() {
    let path;
    switch (game.system.id) {
        case 'dnd5e':
            path = 'price';
...
export function getWeightDataPath() {
    let path;
    switch (game.system.id) {
        case 'dnd5e':
            path = 'weight';
...
export const getActorCurrencyPath = () => {
    let path;
    switch (game.system.id) {
        case 'dnd5e':
        case 'D35E':
