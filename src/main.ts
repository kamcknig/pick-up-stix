...
import { PICK_UP_STIX_MODULE_NAME } from './module/settings';
...
export const debug = (...args) => {
  if (debugEnabled > 1) console.log(`DEBUG:${PICK_UP_STIX_MODULE_NAME} | `, ...args);
};
export const log = (...args) => console.log(`${PICK_UP_STIX_MODULE_NAME} | `, ...args);
export const warn = (...args) => {
  if (debugEnabled > 0) console.warn(`${PICK_UP_STIX_MODULE_NAME} | `, ...args);
};
export const error = (...args) => console.error(`${PICK_UP_STIX_MODULE_NAME} | `, ...args);
export const timelog = (...args) => warn(`${PICK_UP_STIX_MODULE_NAME} | `, Date.now(), ...args);
...
Hooks.once('init', async () => {
  log(` Initializing ${PICK_UP_STIX_MODULE_NAME}`);
